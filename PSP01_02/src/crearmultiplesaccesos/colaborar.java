    ...
    public static void main(String[] args) {
      ...
      if (osName.toUpperCase().contains("WIN")){ //Windows
        if (args.length > 0)
            ...
            nombreFichero = "C:\\listaPalabras.txt";
          ...
          //Hemos recibido la ruta del fichero en la línea de comandos
               ...
               nombreFichero = "/home/listaPalabras.txt";
               //Fichero que se utilizará por defecto
        }
      }
        try{
       ...
       try{
            for (int i = 1; i <=10; i++){
                nuevoProceso = Runtime.getRuntime().exec("java -jar "+
                    "lenguaje.jar " + i*10 + " "+ nombreFichero);
                ...
                System.out.println("java -jar lenguaje.jar " + i*10 + " "+ nombreFichero);
